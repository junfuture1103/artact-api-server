...
if __name__ == "__main__":
    ...
    dataset = datasets.ImageFolder(root="image-data/train",
    ...
    test_dataset = datasets.ImageFolder(root="image-data/test",
                                         transform=transforms.Compose([
                                             transforms.Resize((100,100)),
                                             transforms.ToTensor(),
                                             transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
    ...
    plt.legend()
    plt.savefig('./result_img/Loss_History.png')
    plt.show()
    ...
    plt.savefig('./result_img/Accuracy_History.png')
    plt.legend()
    plt.show()